...
//    @PreAuthorize("@ss.hasPermi('wms:classify:list')")
    @GetMapping("/list")
    public BaseResult list(WmsMaterialClassify wmsMaterialClassify)
    {
...
//    @PreAuthorize("@ss.hasPermi('wms:classify:export')")
...
//    @PreAuthorize("@ss.hasPermi('wms:classify:query')")
    @GetMapping(value = "/{id}")
...
//    @PreAuthorize("@ss.hasPermi('wms:classify:add')")
    @Log(title = "物料分类", businessType = BusinessType.INSERT)
    @PostMapping
    public BaseResult add(@RequestBody WmsMaterialClassify wmsMaterialClassify)
    {
...
//    @PreAuthorize("@ss.hasPermi('wms:classify:edit')")
    @Log(title = "物料分类", businessType = BusinessType.UPDATE)
    @PutMapping
    public BaseResult edit(@RequestBody WmsMaterialClassify wmsMaterialClassify)
    {
...
//    @PreAuthorize("@ss.hasPermi('wms:classify:remove')")
